  ...
  return (
    <div className="bg-surface text-on-surface font-body min-h-screen pb-32">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f7] dark:bg-stone-950 backdrop-blur-md opacity-90 flex justify-between items-center px-6 py-4 border-b border-outline-variant/10">
        ...
        {/* SECTION: HOME */}
        {activeSection === "home" && (
          <section id="home" className="space-y-6 animate-in fade-in duration-200">
        ...
        {activeSection === "policies" && (
          <section id="policies" className="space-y-6 animate-in fade-in duration-200">
        ...
        {activeSection === "claims" && (
          <section id="claims" className="space-y-6 animate-in fade-in duration-200">
        ...
        {activeSection === "profile" && (
          <section id="profile" className="pt-10 pb-40 animate-in fade-in duration-200">
